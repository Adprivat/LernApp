...
- [ ] **BUG-01**: Race Condition bei Challenge-Annahme verhindert doppelte Game Sessions
- [ ] **BUG-02**: Real-time Subscription Leaks bei Navigation zwischen Seiten behoben
