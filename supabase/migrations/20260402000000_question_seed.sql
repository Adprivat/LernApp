-- Add question_seed column to game_sessions for deterministic question shuffling
-- All players in a multiplayer session use the same seed → identical questions & order
ALTER TABLE public.game_sessions ADD COLUMN IF NOT EXISTS question_seed integer;

-- ============================================================
-- Update RPCs to generate question_seed on session creation
-- ============================================================
