...
<!-- For checkpoint task examples and patterns, see @C:/DEV/LernAPP/LernApp/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/DEV/LernAPP/LernApp/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/DEV/LernAPP/LernApp/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/DEV/LernAPP/LernApp/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
