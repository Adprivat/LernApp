...
Reference full template: `C:/DEV/LernAPP/LernApp/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/DEV/LernAPP/LernApp/.claude/get-shit-done/templates/state.md`.
